    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="w-full max-w-md bg-white p-12 border border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-sm">
          ...
          >
            <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mb-4">// WELCOME BACK</div>
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-black mb-2 uppercase">
              Log In
            </h1>
            <p className="text-gray-500 text-sm">
              Access your dashboard to generate synthetic data.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="#" className="text-[10px] font-mono text-gray-500 hover:text-black uppercase tracking-widest transition-colors">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative group">
          ...
          >
            <p className="text-gray-500 text-sm">
              ...
              <Link href="/signup" className="text-black font-bold uppercase tracking-tight hover:underline underline-offset-4">
                Sign up
              </Link>
            </p>
          </motion.div>
